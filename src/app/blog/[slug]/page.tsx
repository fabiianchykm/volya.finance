      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6">
          ...
          <div className="mb-5 flex items-center gap-1.5 text-xs text-zinc-400 dark:text-zinc-500">
            ...
            <span className="truncate font-medium text-zinc-600 dark:text-zinc-300">{post.title}</span>
          </div>
          ...
          <h1 className="mb-6 text-2xl font-bold leading-tight tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-3xl">
            {post.title}
          </h1>

          <article className="rounded-2xl bg-white dark:bg-zinc-900 p-6 shadow-sm ring-1 ring-zinc-200/60 dark:ring-zinc-700 sm:p-8">
            <PostBody content={post.content} />
          </article>

          <Link href={backHref} className="mt-8 inline-flex items-center gap-1.5 text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:underline">
