    ...
    <>
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <h1 className="mb-6 text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-4xl">Статистика</h1>
          <div className="rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-6 py-16 text-center shadow-sm">
            ...
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Незабаром</h2>
