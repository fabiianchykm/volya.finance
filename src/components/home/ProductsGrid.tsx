...
const products: Product[] = [
  {
    ...
    icon: ShieldCheck,
    title: "Автоцивілка",
    desc: "Обовʼязкове страхування (ОСЦПВ). Порівняйте ціни страхових і оформіть поліс онлайн.",
  },
  {
    href: "/kasko",
    icon: Car,
  ...
  },
  {
    ...
    icon: PawPrint,
    title: "Тварини",
    desc: "Страхування котів і собак — ветеринарні витрати та ризики. Незабаром.",
    badge: "Скоро",
  },
];
