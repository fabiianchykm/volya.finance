    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          {/* App Store — скоро (правий верхній кут) */}
          <div
            className={cn(
              "hidden items-center gap-2 rounded-xl px-3 py-1.5 ring-1 lg:flex",
              opaque ? "bg-white text-zinc-900 ring-zinc-200" : "bg-white/10 text-white ring-white/15"
            )}
            title="Застосунок для iPhone — скоро"
          >
            <AppleLogo className="h-4 w-4" />
            <span className="text-xs font-semibold leading-tight">App Store</span>
            <span className="rounded-full bg-indigo-500 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-white">Скоро</span>
          </div>
