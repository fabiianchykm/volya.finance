...
export const KASKO_PRODUCTS: Record<KaskoProduct, KaskoProductConfig> = {
  kasko: {
    ...
    benefits: [
      { icon: Car, title: "ДТП з вашої вини", desc: "Ремонт авто навіть якщо винуватець аварії — ви. ОСЦПВ так не покриває." },
  ...
  "mini-kasko": {
    ...
    benefits: [
      ...
      { icon: Car, title: "ДТП з вашої вини", desc: "Покриває ремонт вашого авто у типових аваріях, яких не покриває ОСЦПВ." },
